                ...
                <div class="card">
                    <form class="form-horizontal" action="{{ route('backend.user.store') }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group"> <label>Foto</label> <img class="foto-preview">
...
@error('foto') is-invalid @enderror"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group"> <label>Hak Ases</label> <select name="role"
...
is-invalid @enderror">
                                    ...
                                    <div class="form-group"> <label>HP</label> <input type="text"
                                            onkeypress="return
hanyaAngka(event)" name="hp"
                                    ...
                                    <div class="form-group">
                                        <label>Konfirmasi Password</label> <input type="password"
                        ...
                        <div class="border-top">
                            <div class="card-body"> <button type="submit" class="btn btn-primary">Simpan</button> <a
                                    href="{{ route('backend.user.index') }}"> <button type="button"
