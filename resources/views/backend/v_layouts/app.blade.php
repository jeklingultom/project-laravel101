                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('backend/image/logo.jpg') }}" width="40" alt="homepage"
                                class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('backend/image/logo_text.png') }}" width="178" alt="homepage"
                                class="light-logo" />
                        </span>
                        <!-- Logo icon -->
                        <!-- <b class="logo-icon"> -->
...
-->
                        <li class="nav-item dropdown">
                            ...
                            waves-dark pro-pic"
                                href="" data-toggle="dropdown" aria-haspopup="true" ariaexpanded="false"><img
...
animated">
                                ...
                                <a class="dropdown-item" href=""
                                    ...
                                    <iclass="fa fa-power-off m-r-5 m-l-5">
                                    </iclass=> Keluar
                                </a>
                                <div class="dropdown-divider"></div>
                            </div>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="{{ route('backend.laporan.formuser') }}"
                                        class="sidebar-link"><i class="mdi mdi-chevronright"></i><span
